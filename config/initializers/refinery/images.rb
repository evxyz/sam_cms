Refinery::Images.configure do |config|
  ...
  # Configure image sizes
   config.user_image_sizes = {:small=>"110x110>", :medium=>"400x400>", :large=>"1200x600>"}
  ...
  # config.dragonfly_secret = "36d94b48029102c4bf263374e58f663c6b5b2fd22a5a5959"
  # If you decide to trust file extensions replace :ext below with :format
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.datastore_root_path = "/Users/evx001/_r_/sam_cms/public/system/refinery/images"
